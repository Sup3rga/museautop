...
insert into `category` (`attached_to`, `branch`, `created_at`, `created_by`, `id`, `modified_at`, `modified_by`, `name`) values ('A', 1, '2026-03-09 18:26:59', 1, 1, '2026-03-09 18:26:59', 1, 'Actualités');
