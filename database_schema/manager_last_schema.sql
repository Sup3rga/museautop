...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;insert into `manager` (`active`, `code`, `created_at`, `created_by`, `firstname`, `id`, `lastname`, `mail`, `nickname`, `phone`) values (1, 'd033e22ae348aeb5660fc2140aec35850c4da997', '2026-03-06 19:52:18', NULL, 'Admin', 1, 'Admin', 'admin@museautop.com', 'admin', '+509 1234 2345');
