...
export default class Ressources{
    ...
    static async fetch(route, data){
        // console.log('[FETCH]',Ressources.apis +route,data);
        try {
            const response = await axios.post(Ressources.apis + route, data);
            // console.log('[Response]', response)
            return response.data;
        }catch (e){
            console.log('[Error]',Ressources.apis +route,data, window.currentBranch,e);
        }
